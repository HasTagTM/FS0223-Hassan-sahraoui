...
// non sono in grado di procedere da solo. Le nozioni sono troppe e non ho anocra le idee chiare. faro un ripasso scritto e torico generale per assorbire tutto. passero il week end a ripassare 
...
for (let character of starWarsCharacters)
     {
        switch (character.eye_color) {
          case 'blue':
            eye_color.blue.push(character);
            break;
          case 'brown':
            eye_color.brown.push(character);
            break;
          case 'yellow':
            eye_color.yellow.push(character);
            break;
          default:
            break;
        }
